...
import math
class Slider(Widget):
    def __init__(self,screen, master_x, master_y, x, y, w, h,
                value, color_background, color_circulo):
    ...
    def draw(self):
        super().draw()
        pygame.draw.circle(self._master, self.color_circulo, 
                           self.rectangulo_circulo.center, self.radio_circulo)
