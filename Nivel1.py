...
class Nivel_1:
    def __init__(self, pantalla: pygame.Surface) -> None:
        ...
        self.FONDO = pygame.image.load(FONDO_NIVEL_1).convert_alpha()
        ...
        self.sonidos(MUSICA_NIVEL_1)

        self.jugador = Personaje((70, 70), piso1.rectangulo, 5)

        
        self.lista_enemigos = lista_de_enemigos_nivel_1
        self.tiempo_creacion_enemigo = pygame.USEREVENT + 1
        pygame.time.set_timer(self.tiempo_creacion_enemigo, 10000)

        self.plataformas = plataformas_nivel_1
        self.lista_monedas = lista_de_monedas_nivel_1
    ...
    def update(self, lista_eventos):
        piso_nuevo = random.choice(plataformas_para_enemigos_nivel_1)
