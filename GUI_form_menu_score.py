...
class FormMenuScore(Form):
    def __init__(self, screen, x, y, w, h, color_background, color_border, 
                active, path_image, scoreboard, margen_y,margen_x, espacio):
        ...
        for j in self._score:
            ...
            for n,s in j.items():
                ...
                pos = Label(screen = self._slave,
                            ...
                            path_image = r"Recursos\Table.png")
        ...
        self.boton_home = Button_Image(screen = self._slave,
                                       ...
                                       onclick_param = "", text="",
                                       font="verdana", font_color="black",
                                       font_size = 15, path_image=r"Recursos\home.png")
