...
piso4 = Plataforma("", 123, 10, 835, 630, False, False)
piso5 = Plataforma("", 117, 10, 449, 474, False, False)
piso6 = Plataforma("", 200, 10, 864, 475, False, False)
piso7 = Plataforma("", 230, 80, 576, 260, False, False)
piso8 = Plataforma("", 200, 20, 135, 372, False, False)
piso9 = Plataforma("", 120, 10, 1152, 387, False, False)
